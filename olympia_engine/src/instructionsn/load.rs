...
fn increment_16a(gb: &mut GameBoy, dest: WordRegister, src: ByteRegister, inc: Increment) -> StepResult<()> {
...
fn a_increment_16(gb: &mut GameBoy, dest: ByteRegister, src: WordRegister, inc: Increment) -> StepResult<()> {
